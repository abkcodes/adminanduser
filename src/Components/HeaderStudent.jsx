        ...
        <header className="container-nav">
            ...
            <AppBar  className="appbar1" position="static">
              <div  className="container-below-nav  shed">
                <Toolbar  className="options-below-nav toolbar1"    sx={{width:"40%",maxWidth:"600",mx:"auto"}}>
                
        
                  <grid container rowSpacing={1} columnSpacing={{xs:2,sm:2,md:3}} >
                    
                  <grid item xs={4} md={4} className="gridheading">
                    <Link to="/user/HomepageStudent"  style={{color:"white", textDecoration:"none"} } underline='none'>
                   
                      <IconButton className="options-below-nav-items options-institute" id="userInstitute" edge="start" ariel-label="menu" sx={{mr:2}}>Institute</IconButton>
                      </Link>
                    ...
                    <Link to="/user/ViewCourse"  style={{color:"white", textDecoration:"none"} } underline='none'>
                      <IconButton className="options-below-nav-items options-courses" id="userEnrolledCourses" edge="start"  ariel-label="menu" sx={{mr:2}}>Courses</IconButton>
                      </Link>
                      </grid>
